...
label_useradi = Label(main, bg="light blue", text="Kullanıcı Adı:", font="verdana 11")
label_useradi.place(x=30, y=95)
entry_useradi = Entry(main, textvariable=text_useradi)
entry_useradi.place(x=130, y=95)
