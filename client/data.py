...
sample_user_data = {"name": "ext_test_user", "password_hash": make_password_ready("ext_test_user_password")}
...
sample_package_data2 = {"name": "ext_test_package2", "days": 12, "detail": "ext_test_package_detail2", "package_contents": [0, 5]}

sample_package_content_data = {"name": "ext_test_package_content", "content_value": pContentEnum.moe_gatherer}

# base_package = 0, user = 0 is id of user and package
sample_u_package_data = {"start_date": datetime.datetime.now(), "base_package": 0, "user": 0}
